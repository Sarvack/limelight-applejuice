...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $configurableAttributes = $this->getConfigureableAttributes();
    ...
    public function convertVariantAsName($variant)
    {
        $variantName = '';
    ...
    private function getConfigureableAttributes()
    {
